  ...
  return (
    <>
      ...
      <motion.div
        ...
        initial={{ opacity: 1, backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)" } as any}
        animate={{ opacity: 0, backdropFilter: "blur(0px)", WebkitBackdropFilter: "blur(0px)" } as any}
